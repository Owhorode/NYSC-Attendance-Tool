 ...
 * Sensitive values from .env; static lookup data co-located here.
 *
 * NaN guards on parseFloat/parseInt: without them, a missing env var
 * silently produces NaN and the geofence comparison (NaN <= 150) is
 * always false — no one can ever check in.
 */
...
export const MASTER_KEYS = {
  LGI:         import.meta.env.VITE_MASTER_KEY_LGI,
  SUPER_ADMIN: import.meta.env.VITE_MASTER_KEY_SUPER_ADMIN,
  SUPER_EMAIL: import.meta.env.VITE_SUPER_ADMIN_EMAIL,
  LGI_EMAIL:   import.meta.env.VITE_LGI_EMAIL,
};
...
export const GEOFENCE = {
  TARGET: {
    lat: parseFloat(import.meta.env.VITE_GEOFENCE_LAT  ?? '6.4634390'),
    lng: parseFloat(import.meta.env.VITE_GEOFENCE_LNG  ?? '3.3928134'),
  },
  MAX_DISTANCE_METERS: parseInt(
    import.meta.env.VITE_GEOFENCE_RADIUS_METERS ?? '150',
    10,
  ),
};
...
export const APP_META = {
  LGA_NAME:   import.meta.env.VITE_APP_LGA_NAME   || 'Lagos Island',
  STATE_NAME: import.meta.env.VITE_APP_STATE_NAME  || 'Lagos',
};

// ---------------------------------------------------------------------------
// CDS STATIC DATA
// ---------------------------------------------------------------------------
export const CDS_GROUPS = [
  'Special CDS',
  'Social Welfare',
  'Health',
  'ICT',
